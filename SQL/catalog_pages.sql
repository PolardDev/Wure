...
(19, 18, 'admin_credit_furni', 'credit_furni', 'default_3x3', 1, 146, 1, 1, '1', '1', '0', '0', 'catalog_bank_headline1', 'catalog_bank_teaser', '', 'Habbo Exchange is where you can convert your Credits into a tradable currency. You can then use this currency to trade for Furni or just show off your riches in your room.', NULL, NULL, NULL, 0, ''),
...
(39, 12, 'triggers', 'Triggers', 'default_3x3', 1, 81, 1, 2, '1', '1', '0', '0', 'catalog_wired_header2_en', 'ctlg_pic_wired_triggers', '', 'Triggers let you define what needs to happen for an Effect to take place. To program a Trigger, place it in a room, double click on it and set it up! You need to stack an Effect with the Trigger to make it work.', NULL, 'Click to see how each Trigger works', NULL, 0, ''),
(40, 12, 'effects', 'Effects', 'default_3x3', 1, 82, 1, 3, '1', '1', '0', '0', 'catalog_wired_header3_en', 'ctlg_pic_wired_effects', '', 'Effects are what happens after you activate a Trigger. To program an Effect, place it in your room, double click on it and set it up! You will always need to stack a Trigger with the Effect to make it work.', NULL, 'Click on an item to see what the\nEffect does!', NULL, 0, ''),
(41, 12, 'conditions', 'Conditions', 'default_3x3', 1, 83, 1, 4, '1', '1', '0', '0', 'catalog_wired_header4_en', 'ctlg_pic_wired_conditions', '', 'Conditions are specific things that need to be done before a Trigger will work. If you want to use a Condition, you will need to stack it with a Trigger and Effect.', NULL, 'Click on an item to see what the\nCondition does!', NULL, 0, ''),
(42, 12, 'addons', 'Add-Ons', 'default_3x3', 1, 85, 1, 5, '1', '1', '0', '0', 'catalog_wired_header5_en', 'ctlg_pic_wired_support_furniture', '', 'Use these simple Furni to bring extra spice to your Wired room. These are basic Furni, so you will still need Triggers, Effects and Conditions\nto make them work!', NULL, 'Use Triggers, Effects and Conditions to make these Furni work!', NULL, 0, ''),
(43, 12, 'leaderboards', 'Leaderboards', 'default_3x3', 1, 256, 1, 6, '1', '1', '0', '0', 'wiredleaderboards_catalog_header', 'wiredleaderboards_teaser', '', 'The High Score furni keep track of scores given in your games and displays them in your room.', NULL, 'Click an item for details', NULL, 0, ''),
(44, 18, 'admin_wired', 'wired', 'default_3x3', 1, 80, 5, 6, '1', '1', '0', '0', 'catalog_wired_header1', 'catalog_wired_header1', '', '', NULL, 'Click an item for details', NULL, 0, ''),
(45, 12, 'soundfx', 'Sound FX', 'default_3x3', 1, 4, 1, 7, '1', '1', '0', '0', 'catalog_wired_header1', 'wiredsound_teaser', '', 'Create your own beats and tracks by combining these sound FX in  your room. Throw a concert for your friends or even start a band in Habbo!', NULL, '', NULL, 0, ''),
(46, 12, 'jukebox', 'Jukebox', 'default_3x3', 1, 4, 1, 8, '1', '1', '0', '0', 'music_header', 'catalog_djshop_teaser1', '', 'Let\'s get loud! Place a Jukebox in your room, add some disks from the \'Habbo Hotel Hits\' below and you\'re ready to have a dance party!', NULL, '', NULL, 0, ''),
(47, 18, 'admin_jukebox', 'trax', 'default_3x3', 1, 4, 5, 8, '1', '1', '0', '0', 'music_header', 'catalog_djshop_teaser1', '', 'Let\'s get loud! Place a Jukebox in your room, add some disks from the \'Habbo Hotel Hits\' below and you\'re ready to have a dance party!', NULL, '', NULL, 0, ''),
(48, 12, 'hotelhits', 'Habbo Hotel Hits', 'soundmachine', 1, 257, 1, 9, '1', '1', '0', '0', 'hotelhits_catalog_header', 'hotelhits_teaser', 'hotelhits_teaser', 'Turn up the volume with some cool new tunes for your room. Place a Jukebox in your room, get yourself some of these song discs and add them to your playlist!', NULL, 'You need to be in a room to\r\n\"pre-listen\" to the disks!', NULL, 0, ''),
